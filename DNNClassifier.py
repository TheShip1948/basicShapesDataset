...
###########################################
def baseline_model(init='TruncatedNormal'): 
	# Create model 
	model = Sequential()
	model.add(Dense(num_pixels, input_dim=num_pixels, init='RandomNormal', activation='relu'))
	model.add(Dense(2000, input_dim=num_pixels, init='TruncatedNormal', activation='relu'))
	#model.add(Dense(50,  init='normal', activation='relu'))
	model.add(Dropout(0.2))
	model.add(Dense(500, input_dim=num_pixels, init='normal', activation='relu'))
	model.add(Dropout(0.2))
	model.add(Dense(200, input_dim=num_pixels, init='he_normal', activation='relu'))
	model.add(Dropout(0.2))	
...
# --- Fit the model ---
###########################################
model.fit(X_train_resized, y_train, validation_data=(X_test_resized, y_test), nb_epoch=100, batch_size=8, verbose=2)
